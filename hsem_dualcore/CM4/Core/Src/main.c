...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
//semafor kimliği ve Semaforu kullanacak olan işlem ID’si
#define HSEM_ID 9
#define HSEM_PROCESS 4
/* USER CODE END PD */
...
/* Private variables ---------------------------------------------------------*/
 // UART2 haberleşme yapısı
UART_HandleTypeDef huart2;

/* USER CODE BEGIN PV */
//Semaforun durumunu saklar. Varsayılan olarak 0 (boşta) olarak başlatılmıştır.
...
/**
  ...
  * @retval None
  */
//Hata durumu için hata işleyici fonksiyon var
...
//kısaca
//CM4 semaforu almak ister. Eğer boşsa alır, işini yapar ve bırakır.
//CM0+ semaforun bırakıldığını kesme ile öğrenir. Semaforu alıp işlemini yapar.
//CM0+ işi bitince semaforu bırakır. CM4 tekrar alabilir.
//Bu döngü, çekirdekler arasında veri paylaşımı ve senkronizasyon sağlamak için devam eder.
//Böylece iki çekirdek, aynı kaynağı çakışmadan kullanabilir.
